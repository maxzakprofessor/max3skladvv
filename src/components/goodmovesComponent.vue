...
<div class="modal-content">
    ...
    <div class="modal-body">
            ...
            <div class="input-group mb-3">
                <span class="input-group-text">nameStockFrom</span>
            ...
            <div class="input-group mb-3">
                <span class="input-group-text">nameStockTowhere</span>
            ...
            <div class="input-group mb-3">
                <span class="input-group-text">nameGood</span>
        ...
        <div class="input-group mb-3">
            <span class="input-group-text">dateInp</span>
            <input type="date" class="form-control" v-model="dateInp">
        </div>

        <div class="input-group mb-3">
            <span class="input-group-text">timeInp</span>
...
methods:{
    ...
    addClick(){
        ...
        this.modalTitle="Add Goods Move";
        this.id=0;
        this.nameStockFrom="";
    ...
    editClick(acc){
        ...
        this.modalTitle="Edit Goods Move";
        this.id=acc.id;
